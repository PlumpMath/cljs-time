...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__4903__auto__,writer__4904__auto__,opt__4905__auto__){return cljs.core._write.call(null,writer__4904__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_14340 = 0;while(true){
if((i_14340 < arr.length))
{(arr[i_14340] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__4903__auto__,writer__4904__auto__,opt__4905__auto__){return cljs.core._write.call(null,writer__4904__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_14347 = (self__.level + 1);while(true){
if((i_14347 <= (new_level + 1)))
{(update[i_14347] = self__.header);
{
var G__14348 = (i_14347 + 1);
i_14347 = G__14348;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_14349 = 0;while(true){
if((i_14349 <= self__.level))
{var links_14350 = (update[i_14349]).forward;if(((links_14350[i_14349]) === x__$1))
{(links_14350[i_14349] = (x__$1.forward[i_14349]));
{
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__4367__auto__ = (cljs.core.truth_((function (){var and__4358__auto__ = me;if(cljs.core.truth_(and__4358__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__4358__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__4367__auto__))
