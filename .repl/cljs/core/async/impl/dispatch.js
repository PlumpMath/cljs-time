...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14363 = 0;while(true){
var m_14364 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14364 == null))
{} else
{m_14364.call(null);
if((count_14363 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14365 = (count_14363 + 1);
count_14363 = G__14365;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__4358__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__4358__auto__)
