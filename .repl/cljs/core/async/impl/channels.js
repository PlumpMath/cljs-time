...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14369 !== 'undefined')
{} else
{goog.provide('cljs.core.async.impl.channels.t14369');

/**
* @constructor
*/
cljs.core.async.impl.channels.t14369 = (function (val,box,meta14370){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14369.cljs$lang$type = true;
cljs.core.async.impl.channels.t14369.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14369";
cljs.core.async.impl.channels.t14369.cljs$lang$ctorPrWriter = (function (this__4903__auto__,writer__4904__auto__,opt__4905__auto__){return cljs.core._write.call(null,writer__4904__auto__,"cljs.core.async.impl.channels/t14369");
});
cljs.core.async.impl.channels.t14369.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t14369.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14371){var self__ = this;
var _14371__$1 = this;return self__.meta14370;
});
cljs.core.async.impl.channels.t14369.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14371,meta14370__$1){var self__ = this;
var _14371__$1 = this;return (new cljs.core.async.impl.channels.t14369(self__.val,self__.box,meta14370__$1));
});
cljs.core.async.impl.channels.__GT_t14369 = (function __GT_t14369(val__$1,box__$1,meta14370){return (new cljs.core.async.impl.channels.t14369(val__$1,box__$1,meta14370));
});
}
return (new cljs.core.async.impl.channels.t14369(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__4906__auto__,writer__4907__auto__,opts__4908__auto__){return cljs.core._write.call(null,writer__4907__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__4903__auto__,writer__4904__auto__,opt__4905__auto__){return cljs.core._write.call(null,writer__4904__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_14372 = self__.takes.pop();if((taker_14372 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_14372))
{var take_cb_14373 = cljs.core.async.impl.protocols.commit.call(null,taker_14372);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_14373,taker_14372){
return (function (){return take_cb_14373.call(null,null);
});})(take_cb_14373,taker_14372))
);
} else
{}
{
